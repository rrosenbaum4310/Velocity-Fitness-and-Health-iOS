...
public class GBTextField: UITextField {
    ...
    public var rightImage: UIImage?{
        didSet{
            ...
            imageView.topAnchor.constraint(equalTo: viewRight!.topAnchor, constant: 0).isActive = true
            imageView.leftAnchor.constraint(equalTo: viewRight!.leftAnchor, constant: 0).isActive = true
            imageView.bottomAnchor.constraint(equalTo: viewRight!.bottomAnchor, constant: 0).isActive = true
            imageView.rightAnchor.constraint(equalTo: viewRight!.rightAnchor, constant: 0).isActive = true
            imageView.clipsToBounds = true
            imageView.contentMode = .center //.scaleToFill
